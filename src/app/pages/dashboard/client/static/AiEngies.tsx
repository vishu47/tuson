...
import TabHeader1 from 'sr/partials/widgets/widgets-components/header/TabHeader1'
  ...
  return (
    <>
      <div className='ai_engines container'>
        <TabHeader1 tab={tab} setTab={setTab} />
        ...
        <div className='listing_app'>
          <CardWidget11 list={tab === 'infoxapis' ? info : image} />
        </div>
      </div>
    </>
  )
